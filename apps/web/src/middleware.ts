...
function applySecurityHeaders(response: NextResponse) {
  ...
  const cspHeader = `
    ...
    img-src 'self' blob: data: https://images.unsplash.com https://res.cloudinary.com https://*.idrivee2-pt.com https://*.idrivee2.com https://logo.clearbit.com https://www.google.com https://*.google.com;
