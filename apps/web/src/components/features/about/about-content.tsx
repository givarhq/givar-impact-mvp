...
export function AboutContent() {
    return (
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-10 animate-in fade-in slide-in-from-bottom-3 duration-500">
            ...
            {/* Core Narrative Section - Compact, Readable Mobile Typography */}
            <section className="space-y-3 sm:space-y-4 text-center sm:text-left text-sm sm:text-base md:text-lg leading-relaxed font-medium text-muted-foreground">
            ...
            {/* The Gap Section */}
            <section className="bg-muted/30 border border-border/40 rounded-3xl p-5 sm:p-8 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl rounded-full -mr-10 -mt-10 pointer-events-none" />
                <div className="relative z-10 space-y-3">
                    <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-foreground">The gap</h2>
                    <div className="space-y-2.5 text-xs sm:text-sm text-muted-foreground leading-relaxed font-medium">
                        <p>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 items-stretch">
                <div className="p-5 sm:p-7 rounded-3xl border border-border/40 bg-card space-y-3 flex flex-col justify-center">
                    <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-foreground">Our approach</h2>
                    <div className="space-y-2 text-xs sm:text-sm text-muted-foreground leading-relaxed font-medium">
                        <p>
                ...
                <div className="p-5 sm:p-7 rounded-3xl border border-primary/20 bg-primary/[0.03] flex flex-col justify-center">
                    <div className="space-y-3.5">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3">
                                ...
                                <span className="text-xs sm:text-sm font-bold text-foreground">{text}</span>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="grid grid-cols-1 sm:grid-cols-12 gap-5 sm:gap-8 items-center bg-card border border-border/40 rounded-3xl p-5 sm:p-8 shadow-sm">
                <div className="sm:col-span-4 flex flex-col items-center text-center space-y-2.5">
                    ...
                    <div className="space-y-0.5">
                        <h4 className="text-sm sm:text-base font-bold text-foreground">Folarin Ajayi</h4>
                        <p className="text-[11px] font-semibold text-muted-foreground">Founder, Givar</p>
                    </div>
                </div>

                <div className="sm:col-span-8 space-y-3">
                    <h3 className="text-xl sm:text-2xl font-bold tracking-tight text-foreground">Why Givar was created</h3>
                    <div className="space-y-2 text-xs sm:text-sm text-muted-foreground leading-relaxed font-medium">
                        <p>
            ...
            <section className="bg-zinc-950 rounded-3xl p-6 sm:p-10 text-center space-y-4 relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-2.5 max-w-lg mx-auto">
                    ...
                    <div className="pt-2 flex justify-center">
                        <Link href="/explore">
                            <Button size="lg" className="h-11 sm:h-12 px-8 rounded-full font-bold bg-primary text-white shadow-md hover:bg-primary/90 transition-all border-0 text-xs sm:text-sm">
