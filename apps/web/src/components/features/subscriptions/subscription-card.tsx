            ...
            <CardContent className="p-4 md:p-5 flex flex-col md:flex-row items-stretch md:items-center gap-4 md:gap-6 min-w-0">
                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] font-medium text-muted-foreground uppercase tracking-tight">
                ...
                <div className="flex items-center justify-between md:justify-end gap-6 pt-3 md:pt-0 border-t md:border-none border-border/40 min-w-0">
                    <div className="text-left md:text-right min-w-0 shrink-0">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest leading-none mb-1.5">Contribution</p>
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <Badge variant="outline" className={cn(
                            "h-8 px-3 rounded-3xl font-bold text-[10px] uppercase tracking-wider border shadow-none",
                            isActive
