        ...
        <Card className="relative overflow-hidden bg-card border-border/40 rounded-3xl p-5 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-5">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 text-xs text-muted-foreground font-medium hover:text-foreground transition-colors group/copy"
                >
            ...
            <div className="space-y-2 mb-6">
                ...
                <div className="h-1.5 w-full bg-muted rounded-3xl overflow-hidden p-0.5 border border-border/40">
                    <div
                        className="h-full bg-primary rounded-3xl transition-all duration-1000 ease-out"
            ...
            <div className="grid grid-cols-2 gap-3 mb-5 transition-all duration-300">
                ...
                {expandedCard !== 'remaining' && (
                    <div
                        ...
                        className={cn(
                            "p-3 rounded-3xl bg-muted/20 border border-border/40 cursor-pointer hover:bg-muted/40 transition-all select-none",
                ...
                <div className="col-span-2 p-3 rounded-3xl bg-muted/20 border border-border/40 flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[11px] font-bold text-muted-foreground uppercase">Donors</span>
                    </div>
            ...
            <Link href={`/dashboard/history?search=${encodeURIComponent(project.title)}`}>
                <Button variant="outline" className="w-full rounded-3xl border-border/60 hover:bg-muted text-xs h-10 font-bold gap-2">
