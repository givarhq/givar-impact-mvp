                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <div className="h-11 flex items-center justify-center p-1 rounded-2xl bg-muted/20 border border-border/60 shadow-inner">
                                        <button
                                            ...
                                            className={cn("flex-1 h-full rounded-xl text-xs font-bold transition-all", tipEnabled ? "bg-primary shadow-sm border border-primary/50 text-white" : "text-muted-foreground opacity-60 hover:bg-muted/50")}
                                        >On</button>
                                        <button
                                            type="button"
