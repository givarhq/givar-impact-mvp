  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between px-1">
        ...
        <Badge variant="outline" className="bg-primary/5 text-primary border-primary/20 rounded-3xl font-bold text-[11px]  tracking-widest px-3">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 relative z-10">
                  ...
                  <div className="flex-1 min-w-0 space-y-1">
                    ...
                    <div className="flex items-center gap-4 mt-3 pt-3 border-t border-border/40">
                      <div className="flex items-center gap-1.5 text-[11px] font-bold text-muted-foreground  tracking-wide">
                  ...
                  <div className="flex items-center gap-2 w-full md:w-auto pt-4 md:pt-0 border-t md:border-none border-border/40">
                    {status !== 'COMPLETED' && (
                      <div className="flex gap-2 w-full md:w-auto">
                        {status === 'PENDING' && (
                          <Button
                            variant="outline"
                            className="flex-1 md:flex-none rounded-3xl h-10 text-[11px] font-bold border-blue-500/20 text-blue-600 hover:bg-blue-500/5  tracking-widest px-4"
                        ...
                        <Button
                          className="flex-1 md:flex-none rounded-3xl font-bold bg-primary hover:bg-primary/90 text-primary-foreground shadow-sm h-10 px-6 text-[11px]  tracking-widest"
                    ...
                    {status === 'COMPLETED' && (
                      <Button
                        variant="ghost"
                        size="sm"
                        className="text-[11px] font-bold  text-muted-foreground hover:text-foreground h-9 rounded-3xl"
                        onClick={() => handleStatusChange(milestone.id, 'IN_PROGRESS')}
                        disabled={!!processingId}
                      >
                        Re-open
