    ...
    <div className="space-y-6 min-w-0">
      ...
      <div className="relative space-y-4 min-w-0">
        ...
        <Dialog open={!!activeMilestone} onOpenChange={(open) => !open && setActiveMilestone(null)}>
          <DialogContent className="rounded-3xl border-none shadow-2xl p-0 bg-card max-w-md min-w-0 max-h-[90vh] flex flex-col overflow-hidden">
            <div className="p-6 md:p-8 overflow-y-auto no-scrollbar flex-1 min-w-0">
              <DialogHeader>
