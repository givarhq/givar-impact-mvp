                ...
                <table className="w-full text-sm text-left border-collapse">
                    <thead className="bg-muted/40 border-b border-border/40 text-muted-foreground">
                        <tr>
                            ...
                            <th className="px-6 py-4 font-bold text-[11px] uppercase tracking-widest">Actor</th>
                            <th className="px-6 py-4 font-bold text-[11px] uppercase tracking-widest">Action</th>
                            <th className="px-6 py-4 font-bold text-[11px] uppercase tracking-widest">Target</th>
                            <th className="px-6 py-4 font-bold text-[11px] uppercase tracking-widest text-right">Timestamp</th>
                        </tr>
                    </thead>
                            ...
                            return (
                                <React.Fragment key={log.id}>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <Badge variant="outline" className={cn("gap-1.5 px-2 py-0 rounded-3xl font-bold text-[10px] uppercase tracking-tight border-0 shadow-none", style.bg, style.color)}>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] font-mono text-muted-foreground opacity-60 truncate max-w-[120px]">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex flex-col items-end">
                                                ...
                                                <span className="text-[10px] font-medium text-muted-foreground uppercase">{formatDate(log.createdAt).split(',')[0]}</span>
                                            </div>
                                        </td>
                                    </tr>
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="grid grid-cols-2 gap-3">
                                                            <div className="p-4 rounded-3xl bg-card border border-border/40">
                                                                ...
                                                                <p className="text-[10px] font-mono font-bold truncate select-all">{log.id}</p>
                                                            </div>
                                                            <div className="p-4 rounded-3xl bg-card border border-border/40">
                                                                <p className="text-[9px] font-bold text-muted-foreground uppercase mb-1">Entity Reference</p>
                                                                <p className="text-[10px] font-mono font-bold truncate select-all">{log.entityId}</p>
                                                            </div>
                                                        </div>
                                                        <div className="p-4 rounded-3xl bg-card border border-border/40">
                                                            <p className="text-[9px] font-bold text-muted-foreground uppercase mb-1">User Agent Trace</p>
                                                            <p className="text-[10px] font-medium text-foreground leading-relaxed break-all">{log.userAgent}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
