...
import {
    ...
    ExternalLink, Calendar, LayoutGrid
} from 'lucide-react';
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-card p-8 rounded-[32px] border border-border shadow-xl relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 w-full lg:w-auto relative z-10">
                    {profile.status !== 'VERIFIED' && (
                        <Button onClick={() => handleReview('VERIFIED')} disabled={isProcessing} className="flex-1 lg:flex-none h-12 px-8 rounded-xl font-bold bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-500/20">
                            Verify Entity
                        </Button>
                    )}
                    <Dialog>
