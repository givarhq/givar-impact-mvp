...
export const LedgerOversightClient = memo(function LedgerOversightClient() {
    ...
    const [activeTab, setActiveTab] = useState(searchRef ? 'reconcile' : 'maintenance');
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 px-1">
                    <TabsList className="bg-muted/50 p-1 rounded-3xl h-11 w-full md:w-fit border border-border/40 shadow-inner">
                        <TabsTrigger value="maintenance" className="flex-1 md:flex-none rounded-3xl px-6 h-full gap-2 font-bold text-xs transition-all data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:shadow-sm">
                            <Wrench className="h-3.5 w-3.5" />
                            System Maintenance
                        </TabsTrigger>
                        <TabsTrigger value="reconcile" className="flex-1 md:flex-none rounded-3xl px-6 h-full gap-2 font-bold text-xs transition-all data-[state=active]:bg-background data-[state=active]:text-primary data-[state=active]:shadow-sm">
