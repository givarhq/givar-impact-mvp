                            ...
                            <tr key={tx.id} className="hover:bg-muted/30 transition-colors group block md:table-row w-full overflow-hidden">
                                <td className="block md:table-cell p-4 md:px-6 md:py-4 border-none w-full">
                                    ...
                                    <div className="mt-3 md:hidden">
                                        <Button
                                            ...
                                            className="rounded-3xl h-9 w-full text-xs font-bold shadow-none border border-border/50 bg-background"
                                        >
                                            Transaction Details
                                        </Button>
                                    </div>
                                ...
                                <td className="hidden md:table-cell px-6 py-4 text-right">
                                    <Button
                                        ...
                                        size="sm"
                                        onClick={() => setSelectedTx(tx)}
                                        className="rounded-3xl h-8 text-xs font-bold px-4"
                                    >
                                        Details
                                    </Button>
                                </td>
                ...
                <DialogContent className="max-w-[calc(100vw-2rem)] sm:max-w-md rounded-[32px] p-0 overflow-hidden border-none shadow-2xl bg-card">
                    {selectedTx && (
                        <div className="p-5 md:p-6 space-y-4 overflow-hidden">
                            ...
                            <div className="text-center p-6 rounded-[32px] bg-muted/30 border border-border/40 relative overflow-hidden">
                                ...
                                <div className="p-4 rounded-3xl bg-card border border-border/40 shadow-sm space-y-3 min-w-0">
                                    ...
                                    <div className="pt-3 border-t border-border/40 flex justify-between items-center gap-4">
                                        ...
                                        <button
                                            ...
                                            className="h-8 w-8 flex items-center justify-center rounded-3xl hover:bg-muted text-muted-foreground hover:text-primary transition-colors border border-border/50 shrink-0"
                            ...
                            <div className="flex flex-col gap-2 pt-1">
                                <Button
                                    ...
                                    className="w-full h-12 rounded-3xl font-bold gap-2 bg-primary text-white shadow-lg shadow-primary/20 border-0"
                                >
