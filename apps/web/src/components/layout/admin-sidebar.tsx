...
import { LayoutDashboard, Users, FileText, ShieldAlert, LogOut, Lock, BadgeCheck, NotebookPen, Database, Camera } from 'lucide-react';
...
const navItems = [
  ...
  { title: 'Evidence Audit', href: '/admin/evidence', icon: Camera },
