...
export default function HowItWorksLoading() {
    return (
        <PublicLayout>
            <div className="container mx-auto px-4 pb-12 max-w-[1400px] pt-2 sm:pt-4 space-y-10 animate-in fade-in duration-500 w-full min-w-0">
                {/* Header Skeleton */}
                <div className="text-center space-y-3 pb-4 sm:pb-6">
                    {/* Only visible on mobile, exactly matching HowItWorksContent */}
                    <Skeleton className="h-4 w-28 mx-auto rounded-3xl md:hidden" />
