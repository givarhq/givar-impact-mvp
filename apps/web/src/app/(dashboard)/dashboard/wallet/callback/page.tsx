        ...
        <CardContent className="p-10 space-y-8">
          {status === 'loading' && (
            <div className="space-y-4 py-8 flex flex-col items-center">
              ...
              <p className="text-muted-foreground">Communicating with Paystack nodes.</p>
            </div>
          )}
          ...
          {status === 'error' && (
            <div className="space-y-6 py-4 animate-in zoom-in-95 duration-500">
              ...
              <p className="text-muted-foreground">We couldn't confirm your payment. If you were debited, please contact support with reference: <span className="font-mono text-xs block mt-2 opacity-70">{reference}</span></p>
