...
import {
    ...
    Lock, Eye, MailCheck, RefreshCw, Globe, Target, BellRing
} from 'lucide-react';
...
export function DonationForm({ project, isAuthenticated }: DonationFormProps) {
    ...
    const handleJoinWaitlist = async () => {
        ...
        try {
            // We use standard apiClient to hit the endpoint we will create in Phase 3
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            // Wallet bypass: Forced Direct Checkout for MVP Compliance
