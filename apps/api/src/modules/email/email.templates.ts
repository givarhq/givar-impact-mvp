export const EmailTemplates = {
  ...
  adminKycSubmitted: (data: { adminName: string; orgName: string; proposerName: string; kycType: string; url: string }) => `
    ...
    <div class="stat-box" style="background-color: #faf5ff; border: 1px solid #e9d5ff;">
      ...
      <p style="font-size: 14px; color: #581c87; margin: 0; font-weight: 600;">${data.kycType === 'INDIVIDUAL' ? 'Verify government identification and liveness check' : 'Verify incorporation documents and registration IDs'} to grant ORGANIZER status.</p>
    </div>
